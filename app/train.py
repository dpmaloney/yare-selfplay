...
def main(args):
  ...
  model.learn(total_timesteps=int(1e9), callback=[eval_callback], reset_num_timesteps = True, tb_log_name="tb")
...
def cli() -> None:
  ...
  parser.add_argument("--env_name", "-e", type = str, default = 'yare'
